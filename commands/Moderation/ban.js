...
const { userResolver } = require('../../utils/resolvers/user');
...
exports.run = async (client, message, args) => {
    ...
    if (!settings.staffMembers.includes(message.author.id) && message.member.hasPermission('BAN_MEMBERS'))
