...
exports.run = async (client, message, args) => {
    ...
    await vMember.user
        .send(
            `Hello ${vMember.user.username} due to an incident that you are involved in, You was warned by a staff member.\n\nReason: ${reason}\n\n**Please Keep a mind that you if you receive __5__ strikes, you'll be permantly banned from ${message.guild.name}**`
        )
        .catch((err) => {
