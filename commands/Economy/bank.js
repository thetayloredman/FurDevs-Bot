...
exports.run = async (client, message, args) => {
    ...
    if (args[0] === 'withdraw') {
        ...
        const embed = new MessageEmbed()
            ...
            .setDescription(
                `Successfully withdrawn ${args[1]} ${BotSettings.currency} from the bank\n\n**Current balance in bank: ${
                    settings.bankCoins - args[1]
        ...
        const embed = new MessageEmbed()
            ...
            .setDescription(
                `Successfully deposited ${args[1]} ${BotSettings.currency} into the bank\n\n**Current balance in bank: ${
                    settings.bankCoins + args[1]
                }** ${BotSettings.currency}`
            )
            .setThumbnail('https://cdn.discordapp.com/attachments/707425515945852949/797640590665056277/th.jpg')
        ...
        if (!message.member.roles.cache.has(message.guild.settings().bankerRole))
            throw new Error('You need to have a Banker Role, to be able to execute this command!');
        if (!message.member.roles.cache.has(message.guild.settings().bankerRole))
            throw new Error('You need to have a Banker Role, to be able to execute this command!');
        ...
        const embed = new MessageEmbed()
            ...
            .setDescription(
                `Successfully added ${args[2]} ${BotSettings.currency} to the bank account of ${user.username}\n\n**Current balance in bank: ${
                    settings.bankCoins + Number(args[2])
                }** ${BotSettings.currency}`
            )
            .setThumbnail('https://cdn.discordapp.com/attachments/707425515945852949/797640590665056277/th.jpg')
            .setColor(`#8800FF`);
        ...
        const embed = new MessageEmbed()
            ...
            .setDescription(
                `Successfully removed ${args[2]} ${BotSettings.currency} from the bank account of ${user.username}\n\n**Current balance in bank: ${
                    settings.bankCoins - Number(args[2])
                }** ${BotSettings.currency}`
            )
            .setThumbnail('https://cdn.discordapp.com/attachments/707425515945852949/797640590665056277/th.jpg')
        ...
        const embed = new MessageEmbed()
            ...
            .setDescription(
                `The current balance in your account is **${settings.bankCoins ? settings.bankCoins : '0'}** ${
                    BotSettings.currency
                }\n\nUser \`>bank withdraw [amount]\` or \`>bank deposit [amount]\` to withdraw or deposit ${
                    BotSettings.currency
